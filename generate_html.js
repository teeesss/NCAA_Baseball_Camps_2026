    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .subtitle {
            ...
            margin: 0 auto 15px; line-height: 1.5;
        }
        ...
        #conf-tabs { display: flex; flex-wrap: wrap; padding: 0; gap: 8px; margin-top: 12px; }

        .conf-btn {
            height: 38px; display: flex; align-items: center; justify-content: center;
            text-align: center; border: 1px solid var(--border-color);
            background: rgba(255, 255, 255, 0.03); border-radius: 10px;
            font-size: 0.75rem; padding: 0 12px; transition: all 0.2s ease;
...
<body>
    ...
    <div class="container">
        <header>
            <div class="hero-badge">Verified 2026 Season (Dev)</div>
            <h1>NCAA Baseball Camps 2026</h1>
            <p class="subtitle">
                <span class="desktop-text">${data.length} DI & DII Programs | ${autoVerifiedCount} Verified Sessions. <em>(Dynamic rendering test)</em></span>
                <span class="mobile-text">${data.length} Schools | ${autoVerifiedCount} Verified. <em>(Dev)</em></span>
            </p>
        </header>
        ...
        <div class="controls-wrapper">
            <div class="glass-panel">
                ...
                <div class="stats-row">
                    ...
                    <div class="stat-bubble"><strong>${autoVerifiedCount}</strong> Verified Sessions</div>
                </div>
            </div>
        </div>
    ...
    function renderCard(item) {
        ...
        // ── Card attributes ──
        const hasDates = dateArr.length > 0;
