...
if (ark) {
  ...
  ark.details =
    "Join the Razorback Baseball Coaching Staff and players for instruction on the fundamentals and skills of the game at Baum-Walker Stadium and the Fowler Family Baseball Indoor Training Center.";
  ark.whatToBring =
    "Players should bring a bat, helmet, glove, cleats, turf shoes/sneakers, and catchers gear (if applicable).";
