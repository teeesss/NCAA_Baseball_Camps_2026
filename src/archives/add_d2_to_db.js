...
const d2File =
  "C:\\Users\\rayjo\\.gemini\\antigravity\\brain\\d7132ad5-9655-481a-a36e-225a4f998064\\.system_generated\\steps\\154\\content.md";
const content = fs.readFileSync(d2File, "utf8");

const schools = [];
// Regex for: [School Name](URL) where URL contains athletic-scholarships/baseball
const regex =
  /\[(.*?)\]\((https:\/\/www\.ncsasports\.org\/athletic-scholarships\/baseball\/.*?)\)/g;
let match;
...
console.log(
  `Added ${addedCount} new DII schools. Total programs: ${masterData.length}`,
);
