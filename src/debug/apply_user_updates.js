...
function applyUpdates() {
  ...
  const updates = [
    {
      ...
      updates: {
        ...
        cost: "$150 - $450 (Varies)",
        details:
          "Rich Maloney Baseball Camps at Ball State University. Prospect & Youth options.",
        isVerified: true,
        isChecked: true,
        scriptVersion: 6,
    ...
    },
    {
      ...
      updates: {
        campUrl:
          "https://www.playnsports.com/organization/robert-woodard-baseball-camps/",
        dates: "Summer 2026",
        cost: "See Site",
        details:
          "UNC Charlotte 49ers official Robert Woodard Baseball Camps. Prospect camps focus on individual development.",
        isVerified: true,
        isChecked: true,
        scriptVersion: 6,
  ...
  updates.forEach((upd) => {
    const idx = data.findIndex(
      (s) => s.university.toLowerCase() === upd.university.toLowerCase(),
    );
    if (idx !== -1) {
