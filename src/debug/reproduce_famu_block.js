...
async function test() {
  ...
  try {
    console.log(`Navigating to http://famubaseballcamps.com/ with NO headers or UA...`);
    await page.goto('http://famubaseballcamps.com/', { waitUntil: 'domcontentloaded', timeout: 15000 });
