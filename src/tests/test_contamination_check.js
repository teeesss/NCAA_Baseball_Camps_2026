...
function runTests() {
  ...
  assert.strictEqual(
    isContaminated("Welcome to Alabama State Baseball Camp", "Alabama", allSchools), 
    true, 
  ...
  assert.strictEqual(
    isContaminated("Welcome to Alabama State Baseball Camp", "Alabama State", allSchools), 
    false, 
