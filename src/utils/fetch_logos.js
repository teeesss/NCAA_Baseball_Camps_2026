...
async function processData() {
    ...
    for (let i = 0; i < campsData.length; i++) {
        ...
        let searchName = school.university.replace(/ University| College| State/ig, '').trim();
        ...
        if (domain) {
            ...
            let isMissing = !school.campUrl || school.campUrl === 'TBA' || school.campUrl === '';
            if (isMissing) {
        ...
        if (i > 0 && i % 50 === 0) console.log(`Processed ${i} / ${campsData.length}...`);
    }
