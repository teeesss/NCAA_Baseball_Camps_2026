 ...
 */
function isContaminated(text, targetUniversity, allUniversities, mascotLookup = null) {
  ...
  if (mascotLookup) {
    ...
    for (const uni of allUniversities) {
        ...
        if (uni.toLowerCase().includes(targetLower) || targetLower.includes(uni.toLowerCase())) {
            ...
            if (rivalMascot && rivalMascot.length > 3 && rivalMascot !== targetMascot && textLower.includes(rivalMascot)) {
