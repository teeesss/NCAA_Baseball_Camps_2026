...
async function sync() {
    ...
    try {
        ...
        await client.downloadTo("human_verifications.json", "human_verifications.json");
        await client.downloadTo("human_verifications_ip.json", "human_verifications_ip.json");
        ...
        const verifications = JSON.parse(fs.readFileSync("human_verifications.json", "utf8"));
        ...
        if (updatedCount > 0) {
            ...
            console.log(`📊 Integrated ${updatedCount} community verifications into master dataset.`);
        }
