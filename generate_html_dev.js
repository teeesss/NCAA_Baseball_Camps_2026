    ...
    <div class="container">
        <header>
            ...
            <p class="hero-subtitle">
                <span class="desktop-text">${data.length} DI & DII Programs | ${autoVerifiedCount} Verified Sessions | Constant Updates</span>
                <span class="mobile-text">${data.length} Schools | ${autoVerifiedCount} Verified | Constant Updates</span>
            </p>
        </header>
