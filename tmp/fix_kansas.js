...
if (idx === -1) { console.error('Kansas not found!'); process.exit(1); }

const COST = '\u002499.00'.replace('99', '299'); // '$299.00' — avoids shell $ stripping

data[idx].campUrl    = 'https://thegoodgame.com/kuathletics/campsandclinics/camp-details/?event_id=1933&sport_id=271';
data[idx].sourceUrl  = 'https://thegoodgame.com/kuathletics/campsandclinics/camp-details/?event_id=1933&sport_id=271';
data[idx].dates      = 'June 15-17, 2026';
data[idx].cost       = COST;
data[idx].details    = '2026 Super Skills Camp hosted by KU Baseball. Open to players entering 4th-7th grade in Fall 2026. Full-day sessions at Allen Fieldhouse.';
...
data[idx].campTiers  = [{
  ...
  cost: COST,
  sessions: [{ label: '', dates: 'June 15-17, 2026', time: '9:00am - 4:00pm CDT' }]
}];
